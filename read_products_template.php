...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<div class='col-md-4 m-b-20px'>";
        ...
        echo "<a href='product.php?id={$id}' class='product-link'>";
            ...
            $row_product_image=$product_image->readFirst();
        ...
        <div class='m-b-10px'>
            ...
            <center>
                <a href='cart.php' class='btn btn-success w-30-pct'>Mis à jour</a>
            </center> 
           ...
           <?php }
              ...
              <?php echo  "
                <center>
                    <a href='add_to_cart.php?id={$id}&page={$page}' class='btn btn-primary w-30-pct'>Ajouter</span></a>
                </center>" ;
           } ?>
        </div>
    </div>

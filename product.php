...
echo "<div class='col-md-5'>";
    ...
    echo "<div class='product-detail'>Prix:</div>";
    echo "<h4 class='m-b-10px price-description'>" . number_format($product->price, 2, '.', ',') . "&#8364;</h4>";
 
    echo "<div class='product-detail'>Déscription:</div>";
    ...
    echo "<div class='product-detail'>Categorie:</div>";
...
echo "<div class='col-md-2'>";
    ...
    if(array_key_exists($id, $_SESSION['cart'])){
        echo "<div class='m-b-10px'>Ce produit exite dans le panier.</div>";
    ...
    // if product was not added to the cart yet
        ...
        echo "<form class='add-to-cart-form'>";
            ...
            echo "<div class='m-b-10px f-w-b'>Quantité:</div>";
            ...
            echo "<button style='width:100%;' type='submit' class='btn btn-primary add-to-cart m-b-10px'>";
                echo "<span class='glyphicon glyphicon-shopping-cart'></span> Ajouter dans le panier";
            echo "</button>";
